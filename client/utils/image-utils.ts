export const getDataUrlFromBlob = (blob: Blob) => new Promise<string>((resolve) => {
...
export const resizeImage = (file: File, optimalSize: number) => new Promise<Blob>(async (resolve, reject) => {
